...
//logout butonuna basarak sistemden cikis yapin
    ...
    public static String raporaResimEkle(String testIsmi,String raporIsmi) throws IOException {
        LocalDate localDate= LocalDate.now();
        DateTimeFormatter format =DateTimeFormatter.ofPattern("_yyMMdd_HHmmss");
        String date=localDate.format(format);//_180424_080623


        //1. adim tss objesi oluşturalım
        //ve takeScreenshot objesi ile gecici resmi kaydedelim
        TakesScreenshot takesScreenshot=(TakesScreenshot) Driver.getDriver();
        File geciciDosya=takesScreenshot.getScreenshotAs(OutputType.FILE);

        //Asil resmi kaydedeceğimiz dosya yolunu olusturup
        //bu dosya yolu ile resmi kaydedeceğimiz asil dosyayı olusturalım
        String dosyaYolu=System.getProperty("user.dir")+"/test-output/Screenshot/"+testIsmi+raporIsmi;
        File asilResimDosyasi=new File(dosyaYolu);
        //gecici dosyayi asil dosyaya kopyalayalım
